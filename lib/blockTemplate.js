...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, poolAddressScript, extraNoncePlaceholder, reward, txMessages, recipients){
    ...
    this.serializeHeader = function(merkleRoot, nTime, nonce, hashStateRoot, hashUTXORoot){
        ...
        header.write(hashStateRoot, position += 32, 32, 'hex');
        header.write(hashUTXORoot, position += 32, 32, 'hex');
